...
class ApiToken
{
    ...
    public const SCOPE_COUNTRY_CREATE = 'ROLE_COUNTRY_CREATE';
    public const SCOPE_COUNTRY_EDIT = 'ROLE_COUNTRY_EDIT';
    public const SCOPES = [
        self::SCOPE_USER_EDIT => 'Edit User',
        self::SCOPE_COUNTRY_CREATE => 'Create Country',
        self::SCOPE_COUNTRY_EDIT => 'Edit Country',
    ];
    ...
    {
        $this->token = $tokenType.bin2hex(random_bytes(321));
    }
